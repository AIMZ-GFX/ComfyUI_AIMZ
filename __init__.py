...
NODE_CLASS_MAPPINGS = {
    ...
    "AIMZ_FallbackSwitch": AIMZ_FallbackSwitch,
    "AIMZ_VAEColorMatch": AIMZ_VAEColorMatch,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "AIMZ_FallbackSwitch": "AIMZ Fallback Switch (Any Type)",
    "AIMZ_VAEColorMatch": "AIMZ VAE Color Match",
